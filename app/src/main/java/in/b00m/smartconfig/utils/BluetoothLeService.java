...
import in.b00m.smartconfig.MainActivity;
...
import static in.b00m.smartconfig.MainActivity.mbleService;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =          "in.b00m.ble.common.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =       "in.b00m.ble.common.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED ="in.b00m.ble.common.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_READ =               "in.b00m.ble.common.ACTION_DATA_READ";
    public final static String ACTION_DATA_NOTIFY =             "in.b00m.ble.common.ACTION_DATA_NOTIFY";
    public final static String ACTION_DATA_WRITE =              "in.b00m.ble.common.ACTION_DATA_WRITE";
    public final static String EXTRA_DATA =                     "in.b00m.ble.common.EXTRA_DATA";
    public final static String EXTRA_UUID =                     "in.b00m.ble.common.EXTRA_UUID";
    public final static String EXTRA_STATUS =                   "in.b00m.ble.common.EXTRA_STATUS";
    public final static String EXTRA_ADDRESS =                  "in.b00m.ble.common.EXTRA_ADDRESS";
 //   public final static String ACTION_DATA_AVAILABLE = "com.example.bluetooth.le.ACTION_DATA_AVAILABLE";
