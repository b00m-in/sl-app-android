...
public class SLOpenGLRenderer implements GLSurfaceView.Renderer {
     ...
     */
    public SLOpenGLRenderer(SLOPenGLSurfaceView cubesurfaceview)
    {
        ...
        final float[] triangle1VerticesData = {
                ...
                -0.5f, -0.5f, -0.5f, // 13 (10)
                -0.5f, -0.5f,  -0.48f, // 14 (1)
                -0.5f,  0.5f,  -0.48f, // 15 (4)
                -0.5f,  0.5f, -0.5f, // 16 (11)


                -0.5f,  0.5f,  -0.48f,  // 17 (4)
                0.5f,  0.5f,  -0.48f,   // 18 (3)
                0.5f,  0.5f, -0.5f,   // 19 (7)
                -0.5f,  0.5f, -0.5f,  // 20 (11)


                -0.5f, -0.5f,  -0.48f,  // 21 (1)
                0.5f, -0.5f,  -0.48f,   // 22 (2)
                0.5f, -0.5f, -0.5f,   // 23 (6)
                -0.5f, -0.5f, -0.5f,  // 24 (10)
...
//		// Position the eye behind the origin.
       ...
       ////Matrix.setLookAtM(mViewMatrix, 0, eyeX, eyeY, eyeZ, lookX, lookY, lookZ, upX, upY, upZ);
        ...
        if (mProgramHandle != 0)
        {
            ...
            mTextureDataHandle0 = loadTexture(mActivityContext, R.drawable.ic_launcher_future);
            mTextureDataHandle1 = loadTexture(mActivityContext, R.drawable.ic_launcher_future);
            mTextureDataHandle2 = loadTexture(mActivityContext, R.drawable.ic_launcher_future);
            mTextureDataHandle3 = loadTexture(mActivityContext, R.drawable.ic_launcher_future);
            mTextureDataHandle4 = loadTexture(mActivityContext, R.drawable.ic_launcher_future);
            mTextureDataHandle5 = loadTexture(mActivityContext, R.drawable.ic_launcher_future);
    ...
    public void onSurfaceChanged(GL10 glUnused, int width, int height)
    {
        ...
        height = (int) (height/1.5f); //height changed to fit into the screen
...
//        for each face of the cube we need 4 textures . so 4*2=8
        mCubeTextureCoordinates.position(8*j);
